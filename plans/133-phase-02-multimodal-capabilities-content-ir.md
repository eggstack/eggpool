...
Complete. Content IR types, MultimodalCapabilities, config overrides, and loss
reason constants are implemented, tested, and documented. Decode/encode helpers
remain for Plan 134.

#!/usr/bin/env python3
"""Validate a complete release artifact directory and release manifest."""
...
class ValidationError(ValueError):
    """A deterministic release artifact-set failure."""
...
def validate_manifest(
    ...
    if manifest.get("manifest_version") != "release-manifest.v1":
        raise ValidationError("unsupported release manifest schema")

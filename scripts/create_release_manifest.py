#!/usr/bin/env python3
"""Create a deterministic manifest from a complete release artifact directory."""
...
def release_version() -> str:
    ...
    value = authority.get("native_release_version")
    if not isinstance(value, str):
        raise ManifestError("catalog native release version is missing")
    return value

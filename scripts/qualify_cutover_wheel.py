#!/usr/bin/env python3
"""Qualify a built K002 wheel in disposable package-manager environments."""
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        ...
        with tempfile.TemporaryDirectory(prefix="eggpool-k002-") as temporary:
            root = Path(temporary)
            (root / "home").mkdir()
            try:
        ...
        print(f"K002 qualification failed: {error}", file=sys.stderr)
        return 1

#!/usr/bin/env python3
"""Check one release artifacts raw executable's target-specific portability contract."""
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        ...
        print(f"release artifacts portability check failed: {error}", file=sys.stderr)
        return 1

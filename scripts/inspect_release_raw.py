#!/usr/bin/env python3
"""Inspect one raw Rust release executable for the artifact contract."""
...
def inspect_raw(
    ...
    *,
    ...
    """Validate one raw executable against the release artifacts contract."""
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        ...
        print(f"release artifacts raw artifact invalid: {error}", file=sys.stderr)
        return 1

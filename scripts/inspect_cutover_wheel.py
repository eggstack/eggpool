#!/usr/bin/env python3
"""Inspect an EggPool Rust cutover wheel using only the Python standard library."""
...
def inspect_wheel(
    ...
    *,
    ...
    """Validate one wheel against the K002 binary-wheel contract."""
    ...
    try:
        with zipfile.ZipFile(path) as archive:
            ...
            if dependencies:
                raise WheelInspectionError(
                    "Rust cutover wheel declares Python dependencies"
                )
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        ...
        print(f"K002 wheel invalid: {error}", file=sys.stderr)
        return 1

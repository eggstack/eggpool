"""P002 Rust production authority and historical-package boundary tests."""
...
from scripts.validate_m12_package_boundary import (
...
def test_release_workflow_rejects_root_python_build_paths() -> None:
    ...
    with pytest.raises(PackageBoundaryError, match="root/historical Python"):
        validate_package_boundary(
            ...
            ).replace("validate_m12_package_boundary.py", "uv build", 1)
        )

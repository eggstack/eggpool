    ...
    return {
        ...
        "failure_cases": {
            case["name"]: {
                ...
                "client_outcome": case["effects"]["client_outcome"],
                "account_effect": case["effects"]["account_effect"],
                "model_effect": case["effects"]["model_effect"],
                "circuit_penalty": case["effects"]["circuit_penalty"],
                "persist_backoff": case["effects"]["persist_backoff"],
                "backoff_reason": case["effects"]["backoff_reason"],
                "backoff_until": case["effects"]["backoff_until"],
                "release_probe_only": case["effects"]["release_probe_only"],

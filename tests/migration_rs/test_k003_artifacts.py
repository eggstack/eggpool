"""Focused contract tests for the K003 wheel/raw artifact matrix."""
...
from scripts.inspect_cutover_raw import RawInspectionError, inspect_raw, raw_filename
from scripts.inspect_cutover_wheel import TARGET_PLATFORMS
from scripts.validate_cutover_artifacts import ValidationError, validate_manifest
...
def test_manifest_binds_every_supported_target_and_payload_hash(tmp_path: Path) -> None:
    ...
    assert manifest["manifest_version"] == "m11-release-manifest.v1"

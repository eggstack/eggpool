...
async def test_concurrent_readers_during_write() -> None:
    ...
    try:
        ...
        db1._last_operation_error_kind = None  # type: ignore[reportPrivateUsage]
        db1._operations_by_kind: dict[str, int] = {}  # type: ignore[reportPrivateUsage]
        ...
        db2._last_operation_error_kind = None  # type: ignore[reportPrivateUsage]
        db2._operations_by_kind: dict[str, int] = {}  # type: ignore[reportPrivateUsage]

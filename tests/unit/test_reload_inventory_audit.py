...
EXPECTED_INVENTORY_SNAPSHOT: tuple[tuple[str, str, bool], ...] = (
    ...
    ("database.recovery", "live", False),
    ("database.recovery.enabled", "live", False),
    ("database.recovery.fail_process_on_exhaustion", "live", False),
    ("database.recovery.initial_backoff_ms", "live", False),
    ("database.recovery.max_attempts", "live", False),
    ("database.recovery.max_backoff_ms", "live", False),
    ("database.recovery.reconciliation_timeout_s", "live", False),
    ...
    ("upstream.read_timeout_s", "live", False),

...
EXPECTED_INVENTORY_SNAPSHOT: tuple[tuple[str, str, bool], ...] = (
    ...
    ("metrics.operational_event_retain_days", "live", False),
    ("metrics.rollup_retain_days", "restart_required", False),
    ("metrics.routing_decision_retain_days", "live", False),
    ...
    ("routing.wire_negotiation.cache_max_entries", "live", False),
    ("routing.wire_negotiation.enabled", "live", False),
    ("routing.wire_negotiation.learned_preference_ttl_s", "live", False),
    ("routing.wire_negotiation.max_concurrent_per_provider", "live", False),
    ("routing.wire_negotiation.min_negotiation_interval_s", "live", False),
    ("routing.wire_negotiation.rejection_cooldown_s", "live", False),

...
EXPECTED_INVENTORY_SNAPSHOT: tuple[tuple[str, str, bool], ...] = (
    ...
    ("database.dispatch_writer.enabled", "restart_required", False),
    ("database.dispatch_writer.enqueue_timeout_ms", "restart_required", False),
    ("database.dispatch_writer.high_pressure_batch_wait_ms", "restart_required", False),
    ("database.dispatch_writer.low_pressure_batch_wait_ms", "restart_required", False),
    ("database.dispatch_writer.max_batch_size", "restart_required", False),
    ("database.dispatch_writer.max_batch_wait_ms", "restart_required", False),
    ("database.dispatch_writer.max_queue_depth", "restart_required", False),
    ("database.dispatch_writer.sample_window", "restart_required", False),
    ("database.dispatch_writer.shutdown_drain_timeout_s", "restart_required", False),
    ("database.path", "restart_required", False),
    ("database.recovery", "restart_required", False),
    ("database.recovery.enabled", "restart_required", False),
    ("database.recovery.fail_process_on_exhaustion", "restart_required", False),
    ("database.recovery.initial_backoff_ms", "restart_required", False),
    ("database.recovery.max_attempts", "restart_required", False),
    ("database.recovery.max_backoff_ms", "restart_required", False),
    ("database.recovery.reconciliation_timeout_s", "restart_required", False),

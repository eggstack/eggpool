...
class TestPolicyDefaults:
    ...
    def test_live_field_inventory_matches_expected(self) -> None:
        ...
        background-policy fields (retention, metrics flush, and backup
        scheduling) whose consumers read from
        ...
        expected_live = {
            ...
            "routing.wire_negotiation.enabled",
...
LIVE_FIELD_CONSUMERS: dict[str, tuple[str, ...]] = {
    ...
    "routing.wire_negotiation.enabled": ("WireProfileResolver",),
    "routing.wire_negotiation.max_concurrent_per_provider": ("WireProfileResolver",),
    "routing.wire_negotiation.min_negotiation_interval_s": ("WireProfileResolver",),
    "routing.wire_negotiation.rejection_cooldown_s": ("WireProfileResolver",),
    "routing.wire_negotiation.learned_preference_ttl_s": ("WireProfileResolver",),
    "routing.wire_negotiation.cache_max_entries": ("WireProfileResolver",),

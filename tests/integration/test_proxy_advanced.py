...
from eggpool.background.cleanup import cleanup_stale_reservations
...
async def test_multiple_accounts_routing() -> None:
    ...
    try:
        ...
        os.environ.pop("GO_AGG_AUTH_KEY", None)
        os.environ.pop("GO_AGG_ACCT1_KEY", None)
        os.environ.pop("GO_AGG_ACCT2_KEY", None)

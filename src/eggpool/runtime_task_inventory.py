...
RUNTIME_TASK_INVENTORY: tuple[RuntimeTaskSpec, ...] = (
    ...
    RuntimeTaskSpec(
        ...
        ownership=TaskOwnership.GENERATION_LEASED,
        enabled=True,
        description="Drain cancellation finalizations that escaped the shielded path",
        reloadable_fields=(),
        generation_dependencies=("finalization_retry_queue",),
        process_dependencies=(),
        callback_kind="finalization_retry_drain",
    ),
    RuntimeTaskSpec(
        ...
        ownership=TaskOwnership.GENERATION_LEASED,
        enabled=True,
        description="Finalize leaked pending requests past the upstream timeout",
        reloadable_fields=("upstream.read_timeout_s",),
        generation_dependencies=("router",),
        process_dependencies=("db",),
        callback_kind="stale_request_finalizer",
    ),
    RuntimeTaskSpec(

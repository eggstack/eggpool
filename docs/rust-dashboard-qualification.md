...
The qualification artifact, when generated by the release qualification
workflow, is stored under `artifacts/qualification/`. It checks every current
dashboard page, public/private auth,

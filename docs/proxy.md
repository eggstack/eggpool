...
EGGPOOL_BASE_URL=http://127.0.0.1:11300 \
EGGPOOL_API_KEY=$(sudo grep ^EGGPOOL_API_KEY /etc/eggpool/env | cut -d= -f2-) \
EGGPOOL_OPENAI_MODEL=gpt-4 \
EGGPOOL_ANTHROPIC_MODEL=claude-3-5-sonnet \

...
bodies and applies that generation's configured request limit. All four public
inference routes (`/v1/chat/completions`, `/v1/messages`, `/v1/responses`,
`/v1/responses/compact`) share this generation-owned body-admission path.

...
| C008 | [Streaming handoff, timeouts, cancellation, and terminal policy](008-streaming-handoff-timeouts-and-cancellation.md) | capability/invariant | **dependency-ready** |
...
Only `migration-rs/registry.md` authorizes an implementation handoff. C008 is now the sole ready coordinator plan after accepted C007 closure.

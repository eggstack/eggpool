...
Status: active; O006 dependency-ready
...
6. [O006 — Migrations, DB maintenance, backup/recover, and automatic backup](006-database-backup-recovery-and-automatic-backup.md) — **dependency-ready; O005 closure accepted**.
...
Only `migration-rs/registry.md` authorizes implementation. O006 is the current dependency-ready plan; O007-O010 remain queued behind their direct predecessors.

...
6. O006 — implement migrate/vacuum/backup/recover and register the real automatic-backup M8 task (**ready; O005 closure accepted**).
...
Only `migration-rs/registry.md` authorizes implementation. O006 is the sole ready plan.

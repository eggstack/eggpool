...
4. O004 — implement config/key/provider/onboarding mutations with validation and live-apply/restart decisions (**ready; O003 closure accepted**).
...
Only `migration-rs/registry.md` authorizes implementation. O004 is the sole ready plan.

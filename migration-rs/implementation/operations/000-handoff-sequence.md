...
5. O005 — implement all `configsetup` target generators and safe output/write/clipboard behavior (**ready; O004 closure accepted**).
...
Only `migration-rs/registry.md` authorizes implementation. O005 is the sole ready plan.

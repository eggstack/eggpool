...
Status: active; Q003 dependency-ready
...
3. [Q003 — Database upgrade, rollback, backup, and recovery compatibility](003-database-upgrade-rollback-backup-recovery-compatibility.md) — **ready**.
...
Only `migration-rs/registry.md` authorizes implementation. Q003 is the sole dependency-ready plan after accepted Q002; later plans are promoted only by accepted closure of their direct predecessor.

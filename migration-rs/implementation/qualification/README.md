...
Status: active; Q006 dependency-ready
...
6. [Q006 — Disposable rootful Linux operational acceptance](006-rootful-linux-operational-acceptance.md) — **ready**.
...
Only `migration-rs/registry.md` authorizes implementation. Q006 is now the sole dependency-ready plan after accepted Q005; later plans are promoted only by accepted closure of their direct predecessor.

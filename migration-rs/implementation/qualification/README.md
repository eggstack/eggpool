...
Status: active; Q004 dependency-ready
...
4. [Q004 — Dashboard SSR, DOM, static asset, and visual parity review](004-dashboard-dom-static-and-visual-parity.md) — **ready**.
...
Only `migration-rs/registry.md` authorizes implementation. Q004 is the sole dependency-ready plan after accepted Q003; later plans are promoted only by accepted closure of their direct predecessor.

...
Status: active; Q005 dependency-ready
...
5. [Q005 — Supported-target build and non-root runtime portability](005-supported-target-build-and-runtime-portability.md) — **ready**.
...
Only `migration-rs/registry.md` authorizes implementation. Q005 is now the sole dependency-ready plan after accepted Q004; later plans are promoted only by accepted closure of their direct predecessor.

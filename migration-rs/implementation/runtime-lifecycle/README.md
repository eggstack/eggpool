...
Status: active; R005 dependency-ready
...
Only `migration-rs/registry.md` authorizes implementation. R001-R003 are
closed, and R005 is the sole current dependency-ready plan; R006-R011 remain
queued serially.

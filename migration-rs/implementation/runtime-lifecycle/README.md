...
Status: active; R002 dependency-ready
...
Only `migration-rs/registry.md` authorizes implementation. R001 is closed and R002 is the sole current dependency-ready plan; R003-R011 remain queued serially.

...
Status: active; R001 dependency-ready
...
Only `migration-rs/registry.md` authorizes implementation. At initial registration, R001 is the sole ready plan and R002-R011 are queued serially.

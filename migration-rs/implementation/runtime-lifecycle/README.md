...
Status: active; R006 dependency-ready
...
Only `migration-rs/registry.md` authorizes implementation. R001-R005 are
closed, and R006 is the sole current dependency-ready plan; R007-R011 remain
queued serially.

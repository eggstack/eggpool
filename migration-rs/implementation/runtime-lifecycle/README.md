...
Status: active; R003 dependency-ready
...
Only `migration-rs/registry.md` authorizes implementation. R001 and R002 are
closed, and R003 is the sole current dependency-ready plan; R004-R011 remain
queued serially.

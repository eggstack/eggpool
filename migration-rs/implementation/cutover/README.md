...
Status: active; K001-K006 closed; K007 conditionally closed pending Linux evidence
...
7. [K007 — Deployed-service cross-era transition and recovery](007-deployed-service-cross-era-transition-and-recovery.md) — **conditionally closed; Linux evidence pending**.
...
Only `migration-rs/registry.md` authorizes implementation. K007 is conditionally closed pending its external Linux evidence; K008-K012 remain queued behind their direct predecessors.

...
Status: active; K001-K004 closed; K005 dependency-ready
...
5. [K005 — Cross-era exact version transitions and rollback](005-cross-era-exact-version-transitions-and-rollback.md) — **ready for handoff**.
...
Only `migration-rs/registry.md` authorizes implementation. K005 is now the sole dependency-ready plan.

...
Status: active; K001 dependency-ready
...
1. [K001 — Cutover, package, and installable-version catalog contract freeze](001-cutover-package-and-version-catalog-contract-freeze.md) — **ready for handoff**.
2. [K002 — Rust PyPI binary-wheel packaging substrate](002-rust-pypi-binary-wheel-packaging-substrate.md) — queued behind K001.
...
Only `migration-rs/registry.md` authorizes implementation. K001 is the sole dependency-ready plan.

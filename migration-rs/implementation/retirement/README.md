...
Status: implementation planning complete; P001-P004 accepted/closed; P005 dependency-ready; P006 queued
...
5. [P005 — Repository, installer, release, and documentation consolidation](005-repository-installer-release-and-documentation-consolidation.md) — **dependency-ready**.
6. [P006 — Rust-only qualification and M12 closure](006-rust-only-qualification-and-m12-closure.md) — queued behind P005.

Only `migration-rs/registry.md` authorizes implementation. P005 is now the sole dependency-ready M12 plan.

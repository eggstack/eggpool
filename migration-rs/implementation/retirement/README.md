...
Status: implementation planning complete; P001 dependency-ready; P002-P006 serially gated
...
2. [P002 — Rust production package, catalog, and cross-era authority](002-rust-production-package-catalog-and-cross-era-authority.md) — queued behind P001.
3. [P003 — Python application source and runtime-asset retirement](003-python-application-source-and-runtime-asset-retirement.md) — queued behind P002.
...
Only `migration-rs/registry.md` authorizes implementation. P001 is the sole dependency-ready M12 plan.

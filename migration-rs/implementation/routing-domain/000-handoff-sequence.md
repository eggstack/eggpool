...
Status: active; D001 ready

Execute and close these plans in dependency order:

1. D001 — contract and deterministic fixture freeze;
2. D002 — account registry and catalog cache/hydration;
...
D004 and D005 share D003 as a hard predecessor and can theoretically proceed independently. Default handoff remains serial to keep review and closure evidence small; register parallel execution explicitly if desired.

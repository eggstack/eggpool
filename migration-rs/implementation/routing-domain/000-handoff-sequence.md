...
Status: active; D001-D005 closed; D006 ready
...
6. D006 — routing eligibility, priority tiers, fairness, and local selection claims (ready);
7. D007 — compiled model-router registry and bounded affinity;
8. D008 — integrated differential qualification and M5 closure.

D004 and D005 shared D003 as a hard predecessor; both are closed and D006 is the current serial handoff. Default handoff remains serial to keep review and closure evidence small.

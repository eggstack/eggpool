...
Status: active; D001 ready for handoff
...
|---|---|---|---|
| D001 | [Contract and deterministic fixture freeze](001-contract-and-fixture-freeze.md) | invariant/infrastructure | ready for handoff |
| D002 | [Account registry and catalog cache/hydration](002-account-registry-and-catalog-cache.md) | capability/invariant | queued behind D001 closure |
| D003 | [Catalog refresh, normalization, and persistence](003-catalog-refresh-normalization-and-persistence.md) | capability/invariant | queued behind D002 closure |
| D004 | [Quota, claims, and fair-share scoring](004-quota-claims-and-fair-scoring.md) | capability/invariant | queued behind D003 closure |
| D005 | [Health, backoff, circuit, and quarantine](005-health-backoff-circuit-and-quarantine.md) | invariant/capability | queued behind D003 closure; D004 may precede it operationally |
...
Only D001 is dependency-ready initially. D004 and D005 are architecturally independent after D003, but do not mark both ready unless the registry explicitly chooses a parallel implementation handoff.

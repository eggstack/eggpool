...
| D009 | [Selection fairness and frozen routing-trace correction](009-selection-fairness-and-trace-snapshot-correction.md) | invariant/corrective | **closed**; see [closure](../../closure/routing-domain/009-status.md) |
...
D009 is closed, M5 is re-closed, and M6 implementation handoff is unblocked. No M6 implementation plan is registered yet; M6 research/planning and its own handoff review may continue. M7 remains blocked on M6.

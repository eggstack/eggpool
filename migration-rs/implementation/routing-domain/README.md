...
Status: active; D001-D002 closed; D003 ready for handoff
...
| D003 | [Catalog refresh, normalization, and persistence](003-catalog-refresh-normalization-and-persistence.md) | capability/invariant | ready for handoff |
...
D003 is the current sole dependency-ready plan. D004 and D005 are architecturally independent after D003, but do not mark both ready unless the registry explicitly chooses a parallel implementation handoff.

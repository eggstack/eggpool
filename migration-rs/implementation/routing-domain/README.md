...
Status: active; D001 closed; D002 ready for handoff
...
| D002 | [Account registry and catalog cache/hydration](002-account-registry-and-catalog-cache.md) | capability/invariant | ready for handoff |
...
D002 is the current sole dependency-ready plan. D004 and D005 are architecturally independent after D003, but do not mark both ready unless the registry explicitly chooses a parallel implementation handoff.

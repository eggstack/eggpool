...
| M6 canonical request/wire codecs | [canonical-wire-roadmap](subsystems/canonical-wire-roadmap.md) | **active** | **W004 ready** |

## Dependency-ready implementation plans

| ID | Plan | Class | Dependencies | Status |
|---|---|---|---|---|
| W004 | [OpenAI Chat Completions and Anthropic Messages codecs](implementation/canonical-wire/004-openai-chat-anthropic-messages-codecs.md) | capability | W003 closed | **ready for handoff** |
...
| W004 | [OpenAI Chat Completions and Anthropic Messages codecs](implementation/canonical-wire/004-openai-chat-anthropic-messages-codecs.md) | **dependency-ready; W003 closed** |
...
W004 is the sole dependency-ready M6 plan. W001-W003 are closed; W005-W010 remain planned but blocked in sequence.
...
F001-F006, M4 T001-T006, and M5 D001-D009 are closed. M6 is active at W004. No M7 implementation plan is dependency-ready.

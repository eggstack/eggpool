...
| M8 runtime generations/rehash/background lifecycle | [runtime-lifecycle-roadmap](subsystems/runtime-lifecycle-roadmap.md) | **active implementation** | **R005 ready** |

## Dependency-ready implementation plans

| ID | Plan | Class | Dependencies | Status |
|---|---|---|---|---|
| R005 | [Config diff, reload policy, and redacted change model](implementation/runtime-lifecycle/005-config-diff-reload-policy-and-redaction.md) | invariant/capability | accepted R004 closure | **dependency-ready** |

R006-R011 remain serially blocked behind the accepted closure of their immediate predecessor. M9 is blocked on accepted R011 M8 closure and its own planning/implementation review.
...
| R005 | [Config diff, reload policy, and redacted change model](implementation/runtime-lifecycle/005-config-diff-reload-policy-and-redaction.md) | **dependency-ready**; R004 |
...
Only the dependency-ready table authorizes implementation. R005 is the sole current M8 handoff.
...
F001-F006, M4 T001-T006, M5 D001-D009, M6 W001-W012, and M7 C001-C011 with C012-C014 corrective passes remain closed. M8 is active with R001-R004 closed, R005 ready, and R006-R011 serially blocked.

...
|---|---|---|---|
| Migration foundation | [foundation-roadmap](subsystems/foundation-roadmap.md) | active | F005 |

## Dependency-ready implementation plans

| ID | Plan | Class | Dependencies | Status |
|---|---|---|---|---|
| F005 | [Axum SSR shell and static-asset parity baseline](implementation/foundation/005-axum-ssr-shell-and-static-assets.md) | capability | F002 closed; F004 interface for DB-backed pages | ready for handoff |
...
F001 through F004 are closed. F005's F003 config and F004 read-interface
dependencies are now satisfied, so F005 is dependency-ready.

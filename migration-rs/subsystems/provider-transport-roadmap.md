...
T003 is the current dependency-ready handoff after T002 closure. Later plans are registered now so the complete workstream is visible, but each becomes ready only after its hard predecessor closes.

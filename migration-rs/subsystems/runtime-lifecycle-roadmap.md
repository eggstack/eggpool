...
Status: active implementation; R004 dependency-ready
...
Only the dependency-ready table in `../registry.md` authorizes implementation. R004 is the sole ready plan after accepted R003 closure.

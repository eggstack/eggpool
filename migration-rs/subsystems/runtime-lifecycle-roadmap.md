...
Status: active implementation; R003 dependency-ready
...
Only the dependency-ready table in `../registry.md` authorizes implementation. R003 is the sole ready plan after accepted R002 closure.

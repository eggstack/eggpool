...
Status: active implementation; R005 dependency-ready
...
Only the dependency-ready table in `../registry.md` authorizes implementation. R005 is the sole ready plan after accepted R004 closure.

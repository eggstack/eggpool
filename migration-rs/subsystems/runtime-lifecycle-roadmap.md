...
Status: active implementation; R007 dependency-ready
...
Only the dependency-ready table in `../registry.md` authorizes implementation. R007 is the sole ready plan after accepted R006 closure.

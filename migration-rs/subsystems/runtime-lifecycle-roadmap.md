...
Status: active implementation; R006 dependency-ready
...
Only the dependency-ready table in `../registry.md` authorizes implementation. R006 is the sole ready plan after accepted R005 closure.

...
- **Frozen prepared payloads**: cached transcode mappings/tuples remain on the conservative ownership path until Plan 115; immutable mapping proxies are never passed to `deepcopy`.
